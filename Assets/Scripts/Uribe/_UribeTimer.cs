...
public class _UribeTimer : MonoBehaviour
{
    Image BarraTiempo;
    ...
    public void Ganar()
    {
        AuidoScript.instance.Stop("UribeMosco");
        AuidoScript.instance.Mute("Marcha");
        AuidoScript.instance.Play("UribeDinero");
        
        TextoPerder.text = "¡Logrado!";
        Jugando = false;
    ...
    public void Perder()                                   //LO QUE SUCEDE CUANDO PIERDES
    {
        AuidoScript.instance.Stop("UribeMosco");
        AuidoScript.instance.Mute("Marcha");
        FindObjectOfType<_flyManager>().Perder();
